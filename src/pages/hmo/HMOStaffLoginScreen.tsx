...
import { hmoAPI } from "@/services/portalService";
import { useAuth } from "@/context/AuthContext";

const HMOStaffLoginScreen = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await hmoAPI.login({
        email: identifier,
        password,
      });
      ...
      if (responseMsg.includes('invalid') || msg.includes('invalid') || responseMsg.includes('credentials') || msg.includes('credentials')) {
        ...
        setError("Account not found. Please check if you have an HMO account.");
      } else if (responseMsg.includes('forbidden') || msg.includes('forbidden')) {
        setError("Access denied. Your account does not have HMO permissions.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#2563EB] rounded-2xl mx-auto mb-4 flex items-center justify-center">
            <Shield className="h-8 w-8 text-white" />
          </div>
          <Badge className="bg-[#2563EB] text-white mb-4">
            Health Maintenance Organization
          </Badge>
          <h1 className="text-2xl font-bold text-gray-900">HMO Portal</h1>
          <p className="text-gray-600 mt-2">Sign in to manage patients and claims</p>
        </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    type="text"
                    placeholder="HMO/2024/000001 or staff@hmo.org"
                    value={identifier}
...
export default HMOStaffLoginScreen;