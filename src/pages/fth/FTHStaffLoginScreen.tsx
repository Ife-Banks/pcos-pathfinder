...
const FTHStaffLoginScreen = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fthAPI.login({
        email: identifier,
        password,
      });
      ...
      if (!['fth_admin', 'fth_staff'].includes(user.role)) {
        setError("Your account does not have Federal Teaching Hospital access.");
        return;
      }
      ...
      if (responseMsg.includes('invalid') || msg.includes('invalid') || responseMsg.includes('credentials') || msg.includes('credentials')) {
        ...
        setError("Account not found. Please check if you have a Federal Teaching Hospital staff account.");
      } else if (responseMsg.includes('forbidden') || msg.includes('forbidden')) {
        setError("Access denied. Your account does not have Federal Teaching Hospital permissions.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-purple-100 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Federal Teaching Hospital Portal</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    type="text"
                    placeholder="FTH/2024/000001 or staff@fth.gov.ng"
                    value={identifier}
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500">
            AI-MSHM Federal Teaching Hospital Portal v1.0.0
          </p>
        </div>
      </motion.div>
    </div>
...
export default FTHStaffLoginScreen;