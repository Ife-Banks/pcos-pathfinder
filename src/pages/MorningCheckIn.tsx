    ...
    <div className="min-h-screen bg-gray-50">
      <div className="px-6 pt-8 pb-4" style={{ backgroundColor: TEAL_PRIMARY }}>
        <div className="flex items-center justify-between mb-4">
          <button onClick={() => navigate('/dashboard')} className="flex items-center gap-1 rounded-full px-3 py-2 text-white/80 transition duration-200 ease-in-out hover:bg-white hover:text-green-600 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50">
