...
import { pvtAPI } from "@/services/portalService";
import { useAuth } from "@/context/AuthContext";

const PrivateHospitalLoginScreen = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await pvtAPI.login({
        email: identifier,
        password,
      });
      ...
      if (!['pvt_admin', 'pvt_staff'].includes(user.role)) {
        setError("Your account does not have Private Hospital access.");
        return;
      }
      ...
      if (responseMsg.includes('invalid') || msg.includes('invalid') || responseMsg.includes('credentials') || msg.includes('credentials')) {
        ...
        setError("Account not found. Please check if you have a Private Hospital account.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-amber-100 p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#D97706] rounded-2xl mx-auto mb-4 flex items-center justify-center">
            <Building2 className="h-8 w-8 text-white" />
          </div>
          <Badge className="bg-[#D97706] text-white mb-4">
            Private Hospital
          </Badge>
          <h1 className="text-2xl font-bold text-gray-900">Private Hospital Portal</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    type="text"
                    placeholder="PVT/2024/000001 or staff@privatehospital.org"
                    value={identifier}
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500">
            AI-MSHM Private Hospital Portal v1.0.0
          </p>
        </div>
      </motion.div>
    </div>
...
export default PrivateHospitalLoginScreen;