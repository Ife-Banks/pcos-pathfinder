...
import { sthAPI } from "@/services/portalService";
import { useAuth } from "@/context/AuthContext";

const STHStaffLoginScreen = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await sthAPI.login({
        email: identifier,
        password,
      });
      ...
      if (responseMsg.includes('invalid') || msg.includes('invalid') || responseMsg.includes('credentials') || msg.includes('credentials')) {
        ...
        setError("Account not found. Please check if you have a State Hospital staff account.");
      } else if (responseMsg.includes('forbidden') || msg.includes('forbidden')) {
        setError("Access denied. Your account does not have State Hospital permissions.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-teal-100 p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#0D9488] rounded-2xl mx-auto mb-4 flex items-center justify-center">
            <span className="text-white text-2xl font-bold">AI-MSHM</span>
          </div>
          <Badge className="bg-[#0D9488] text-white mb-4">
            State General Hospital
          </Badge>
          <h1 className="text-2xl font-bold text-gray-900">State Hospital Portal</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    type="text"
                    placeholder="STH/2024/000001 or staff@sth.gov.ng"
                    value={identifier}
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500">
            AI-MSHM State Hospital Portal v1.0.0
          </p>
        </div>
      </motion.div>
    </div>
...
export default STHStaffLoginScreen;