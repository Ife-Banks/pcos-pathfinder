...
const PrivateTeachingHospitalLoginScreen = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await ptthAPI.login({
        email: identifier,
        password,
      });
      ...
      if (responseMsg.includes('invalid') || msg.includes('invalid') || responseMsg.includes('credentials') || msg.includes('credentials')) {
        ...
        setError("Account not found. Please check if you have a Private Teaching Hospital account.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 to-yellow-100 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Private Teaching Hospital Portal</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    type="text"
                    placeholder="PTTH/2024/000001 or staff@ptth.org"
                    value={identifier}
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500">
            AI-MSHM Private Teaching Hospital Portal v1.0.0
          </p>
        </div>
      </motion.div>
    </div>
...
export default PrivateTeachingHospitalLoginScreen;