...
export const authAPI = {
  ...
  changePassword: async ({ new_password, confirm_password, old_password }) => {
    const res = await apiClient.post('/auth/me/change-password/', { new_password, confirm_password, old_password });
    return res.data;
  },
};